...
{
    private List<SpriteSwitcher> clickedSwitchers = new List<SpriteSwitcher>();
    ...
    private SpriteSwitcher finalSelectedSwitcher; // To store the final selected switcher
    private Dictionary<SpriteSwitcher, string> switcherToSceneMap; // Map each switcher to a scene
    ...
    private string sub = "hmm... escolha interessante...";
    ...
    public void SpriteSwitcherClicked(SpriteSwitcher switcher)
    {
    ...
    {
        switcherToSceneMap = new Dictionary<SpriteSwitcher, string>();
        foreach (var switcherObject in allSwitcherObjects)
        {
            var switcher = switcherObject.GetComponent<SpriteSwitcher>();
            if (switcher != null)
            {
                ...
                {
                    case "Card1":
                        switcherToSceneMap[switcher] = "2nd Scene";
                        break;
                    case "Card2":
                        switcherToSceneMap[switcher] = "2nd Scene";
                        break;
                    case "Card3":
                        ...
                        break;
                    case "Card4":
                        switcherToSceneMap[switcher] = "2nd Scene 2";
                        break;
                    case "Card5":
                        switcherToSceneMap[switcher] = "2nd Scene 2";
                        break;
    ...
    private void LoadSceneForSwitcher(SpriteSwitcher switcher)
    {
    ...
    void HideUnselectedSwitchers()
    {
        foreach (var switcherObject in allSwitcherObjects)
        {
            SpriteSwitcher switcherComponent = switcherObject.GetComponent<SpriteSwitcher>();
    ...
    void FinalizeSelection(SpriteSwitcher selectedSwitcher)
    {
        foreach (var switcherObject in allSwitcherObjects)
        {
            SpriteSwitcher switcherComponent = switcherObject.GetComponent<SpriteSwitcher>();
