...
public class MV7 : MonoBehaviour
{
    ...
    IEnumerator ZoomInCamera()
    {
        ...
        {
            mainCamera.orthographicSize = Mathf.Lerp(startSize, targetZoomSize, elapsed / zoomInDuration);
            mainCamera.transform.position = Vector3.Lerp(startPosition, zoomFocusPoint, elapsed / zoomInDuration);
    ...
    IEnumerator ZoomOutCamera()
    {
        ...
        {
            mainCamera.orthographicSize = Mathf.Lerp(startSize, originalCameraSize, elapsed / zoomOutDuration);
            mainCamera.transform.position = Vector3.Lerp(startPosition, originalCameraPosition, elapsed / zoomOutDuration);
            elapsed += Time.deltaTime;
            yield return null;
        }
